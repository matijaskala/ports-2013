...
SRC_URI="http://ftp.osuosl.org/debian/pool/main/l/linux//${KERNEL_ARCHIVE} http://ftp.osuosl.org/debian/pool/main/l/linux/${PATCH_ARCHIVE}"
S="$WORKDIR/linux-${CKV}"
...
src_prepare() {
	...
	epatch ${FILESDIR}/debian-sources-3.13.10-xfs-libcrc32c-fix.patch
