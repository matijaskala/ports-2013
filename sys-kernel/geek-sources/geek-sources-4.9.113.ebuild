...
MAGEIA_REPO_URI="svn://svn.mageia.org/svn/packages/cauldron/kernel/releases/4.9.40/1.mga7/PATCHES/patches -> mageia/4.9.40"
...
mageia_apply() {
	geek_apply `grep -ve '#' -ve '3rd' -ve 'fs-aufs' -ve 'mageia-logo' -ve 'ALC215' series`
}
