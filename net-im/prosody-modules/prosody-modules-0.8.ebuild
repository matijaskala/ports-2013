...
EHG_REPO_URI="https://code.google.com/p/prosody-modules.0-8"
...
PROSODY_MODULES="
	...
	auto_accept_subscriptions blocking c2s_conn_throttle carbons compat_bind compat_muc_admin 
        component_roundrobin conformance_restricted couchdb data_access default_bookmarks 
	default_vcard discoitems extdisco flash_policy group_bookmarks host_guard ipcheck json_streams
	lastlog latex log_auth mam mam_adhoc motd_sequential muc_intercom muc_limits
	muc_log muc_log_http offline_email onhold openid pastebin post_msg register_json register_redirect 
	reload_modules remote_roster roster_command s2s_idle_timeout s2s_never_encrypt_blacklist
